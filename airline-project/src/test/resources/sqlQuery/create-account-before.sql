...
VALUES ('Admin', 'Adminov', TO_DATE('1999/09/09', 'YYYY/MM/DD'), '79777776777',  'admin3@mail.ru',
        'Admin125@', 'вопрос 11', 'ответ 11', 4);

INSERT INTO account (first_name, last_name, birth_date, phone_number, email, password, security_question, answer_question, account_id)
VALUES ('Манагер', 'Манагеров', TO_DATE('2000/02/02', 'YYYY/MM/DD'), '79666656666', 'manager5@mail.ru',
        'Manager153@', 'вопрос 12', 'ответ 12', 5);

INSERT INTO account (first_name, last_name, birth_date, phone_number, email, password, security_question, answer_question, account_id)
VALUES ('Манагер', 'Манагеров', TO_DATE('2000/02/02', 'YYYY/MM/DD'), '79666556666', 'manager10@mail.ru',
