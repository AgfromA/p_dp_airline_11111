...
//        for (int i = 0; i < searchResult.getFlights().size(); i++) {
//            if (searchResult.getFlights().get(i).getDataBack().getAirportFrom() == search.getTo() &&
//                    searchResult.getFlights().get(i).getDataBack().getAirportTo() == search.getFrom()) {
...
//        for (int i = numberOfDirectReturnFlights; i < searchResult.getFlights().size() - 1; i++) {
//            if (searchResult.getFlights().get(i).getDataBack().getAirportFrom() == search.getTo() &&
//                    searchResult.getFlights().get(i).getDataBack().getAirportTo()
//                            == searchResult.getFlights().get(i + 1).getDataBack().getAirportFrom() &&
//                    searchResult.getFlights().get(i + 1).getDataBack().getAirportTo() == search.getFrom()) {
...
////        var searchResult = getSearchResult(json);
////        for (int i = 0; i < searchResult.getFlights().size(); i++) {
////            assertEquals(search.getDepartureDate(), searchResult.getFlights().get(i).getDataTo().getDepartureDateTime().toLocalDate());
////            int numberOfFreeSeats = 0;
////            for (int j = 0; j < searchResult.getFlights().get(i).getDataTo().getSeats().size(); j++) {
////                if (!searchResult.getFlights().get(i).getSeats().get(j).getIsBooked()
////                        && !searchResult.getFlights().get(i).getSeats().get(j).getIsSold() &&
////                        !searchResult.getFlights().get(i).getSeats().get(j).getIsRegistered()) {
////                    numberOfFreeSeats++;
////                }
////            }
...
////        var searchResult = getSearchResult(json);
////        for (int i = 0; i < searchResult.getFlights().size(); i++) {
////            assertEquals(search.getReturnDate(), searchResult.getFlights().get(i).getDataBack().getDepartureDateTime().toLocalDate());
////            int numberOfFreeSeats = 0;
////            for (int j = 0; j < searchResult.getFlights().get(i).getSeats().size(); j++) {
////                if (!searchResult.getFlights().get(i).getSeats().get(j).getIsBooked()
////                        && !searchResult.getFlights().get(i).getSeats().get(j).getIsSold() &&
////                        !searchResult.getFlights().get(i).getSeats().get(j).getIsRegistered()) {
////                    numberOfFreeSeats++;
